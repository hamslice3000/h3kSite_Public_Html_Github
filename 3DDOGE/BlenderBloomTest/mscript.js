...
/* Selective Bloom Pass https://www.youtube.com/watch?v=er02gtD8asA */
...
(function() {
  ...
  function init() {
    ...
    const MODEL_PATH = './Doge_GLow_Group_Test_01.glb';
    //Canvas "c"
    ...
    let selectedObjectsForBloom = new Selection();
    ...
    selectiveBloom.selection = selectedObjectsForBloom;
